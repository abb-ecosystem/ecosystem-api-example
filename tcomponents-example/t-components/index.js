...
const T_COMPONENTS_BASE_VERSION = '0.6';
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
  // console.log(' Module support is detected, loading TComponents as module...');
} else {
  // console.log(' Module support is not detected, loading TComponents as global variable...');
