...
const Popup_A = (function () {
  ...
  return {
     ...
     * @param {boolean} value If true, the popups appear on the screen. If false, the popups are blocked and instead the messages are displayed on the debug console.
     */
    get show() {
      return _show;
    },
     ...
     * @alias enabled
     * @memberof TComponents.Popup_A
     * @param {boolean} value If true, the popups are completelly disabled. No message appears on the debuge console neither.
     */
    get enabled() {
      return _enabled;
    },
