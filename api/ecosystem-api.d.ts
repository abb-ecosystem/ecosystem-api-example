...
declare namespace API {
  let ECOSYSTEM_LIB_VERSION: string;
  let ECOSYSTEM_MOTION_LIB_VERSION: string;
  let ECOSYSTEM_CFG_LIB_VERSION: string;
   ...
   * @private
   */
  function waitForCondition(func: Function, interval_ms?: Number): Promise<any>;
  ...
  namespace FILESYSTEM {
    ...
    function getFileContents(path: string, file: string): string;
  }
